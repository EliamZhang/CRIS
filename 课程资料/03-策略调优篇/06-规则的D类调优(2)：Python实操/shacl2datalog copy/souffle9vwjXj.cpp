...
namespace  souffle {
using namespace souffle;
class Sf_souffle9vwjXj: public SouffleProgram {
public:
 Sf_souffle9vwjXj();
 ~Sf_souffle9vwjXj();
void run();
...
namespace  souffle {
using namespace souffle;
 Sf_souffle9vwjXj::Sf_souffle9vwjXj():
symTable({
  R"_(minCount)_",
...
void Sf_souffle9vwjXj::runFunction(std::string inputDirectoryArg,std::string outputDirectoryArg,bool performIOArg,bool pruneImdtRelsArg){
...
void Sf_souffle9vwjXj::run(){
runFunction("", "", false, false);
}

void Sf_souffle9vwjXj::runAll(std::string inputDirectoryArg,std::string outputDirectoryArg,bool performIOArg,bool pruneImdtRelsArg){
runFunction(inputDirectoryArg, outputDirectoryArg, performIOArg, pruneImdtRelsArg);
}

void Sf_souffle9vwjXj::printAll([[maybe_unused]] std::string outputDirectoryArg){
try {std::map<std::string, std::string> directiveMap({{R"_(IO)_",R"_(file)_"},{R"_(attributeNames)_",R"_(entity	constraint	message)_"},{R"_(auxArity)_",R"_(0)_"},{R"_(name)_",R"_(violation)_"},{R"_(operation)_",R"_(output)_"},{R"_(output-dir)_",R"_(results)_"},{R"_(params)_",R"_({"records": {}, "relation": {"arity": 3, "params": ["entity", "constraint", "message"]}})_"},{R"_(types)_",R"_({"ADTs": {}, "records": {}, "relation": {"arity": 3, "types": ["s:symbol", "s:symbol", "s:symbol"]}})_"}});
...
void Sf_souffle9vwjXj::loadAll([[maybe_unused]] std::string inputDirectoryArg){
try {std::map<std::string, std::string> directiveMap({{R"_(IO)_",R"_(file)_"},{R"_(attributeNames)_",R"_(entity	value)_"},{R"_(auxArity)_",R"_(0)_"},{R"_(fact-dir)_",R"_(results/facts)_"},{R"_(name)_",R"_(birthDate)_"},{R"_(operation)_",R"_(input)_"},{R"_(params)_",R"_({"records": {}, "relation": {"arity": 2, "params": ["entity", "value"]}})_"},{R"_(types)_",R"_({"ADTs": {}, "records": {}, "relation": {"arity": 2, "types": ["s:symbol", "s:symbol"]}})_"}});
...
void Sf_souffle9vwjXj::dumpInputs(){
...
void Sf_souffle9vwjXj::dumpOutputs(){
try {std::map<std::string, std::string> rwOperation;
rwOperation["IO"] = "stdout";
...
SymbolTable& Sf_souffle9vwjXj::getSymbolTable(){
return symTable;
}

RecordTable& Sf_souffle9vwjXj::getRecordTable(){
return recordTable;
}

void Sf_souffle9vwjXj::setNumThreads(std::size_t numThreadsValue){
...
void Sf_souffle9vwjXj::executeSubroutine(std::string name,const std::vector<RamDomain>& args,std::vector<RamDomain>& ret){
...
namespace souffle {
SouffleProgram *newInstance_souffle9vwjXj(){return new  souffle::Sf_souffle9vwjXj;}
SymbolTable *getST_souffle9vwjXj(SouffleProgram *p){return &reinterpret_cast<souffle::Sf_souffle9vwjXj*>(p)->getSymbolTable();}
} // namespace souffle
...
namespace  souffle {
using namespace souffle;
class factory_Sf_souffle9vwjXj: souffle::ProgramFactory {
public:
souffle::SouffleProgram* newInstance();
 factory_Sf_souffle9vwjXj();
private:
};
} // namespace  souffle
namespace  souffle {
using namespace souffle;
souffle::SouffleProgram* factory_Sf_souffle9vwjXj::newInstance(){
return new  souffle::Sf_souffle9vwjXj();
}

 factory_Sf_souffle9vwjXj::factory_Sf_souffle9vwjXj():
souffle::ProgramFactory("souffle9vwjXj"){
}
...
extern "C" {
souffle::factory_Sf_souffle9vwjXj __factory_Sf_souffle9vwjXj_instance;
}
#endif
} // namespace souffle
