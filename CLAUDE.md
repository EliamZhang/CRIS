...
- `策略开发及优化/`：4 个核心 md（策略开发、策略调优、贷前策略、贷中策略）
- `产品介绍/`：产品介绍方法论（最近提交涉及）
...
| 篇目 | 主要内容 |
|------|----------|
| `01-业务篇` | 信贷业务介绍/场景/岗位/机构（4 个 PDF + 整理 md） |
| `02-策略开发篇` | 规则认识、规则生成（单变量/交叉表/决策树）、规则集、性能测试 |
| `03-策略调优篇` | 调优方法论、A类/D类调优、拒绝回捞、客群下探、策略置换 |
| `04-报表篇` | Vintage 报表、迁徙率报表 |
| `05-评估指标篇` | Lift、PSI、KS、AUC、CSI 指标 |
