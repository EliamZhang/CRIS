...
namespace  souffle {
using namespace souffle;
class Sf_souffleARpHRt: public SouffleProgram {
public:
 Sf_souffleARpHRt();
 ~Sf_souffleARpHRt();
void run();
...
namespace  souffle {
using namespace souffle;
 Sf_souffleARpHRt::Sf_souffleARpHRt():
symTable({
  R"_(minCount)_",
...
void Sf_souffleARpHRt::runFunction(std::string inputDirectoryArg,std::string outputDirectoryArg,bool performIOArg,bool pruneImdtRelsArg){
...
void Sf_souffleARpHRt::run(){
runFunction("", "", false, false);
}

void Sf_souffleARpHRt::runAll(std::string inputDirectoryArg,std::string outputDirectoryArg,bool performIOArg,bool pruneImdtRelsArg){
runFunction(inputDirectoryArg, outputDirectoryArg, performIOArg, pruneImdtRelsArg);
}

void Sf_souffleARpHRt::printAll([[maybe_unused]] std::string outputDirectoryArg){
try {std::map<std::string, std::string> directiveMap({{R"_(IO)_",R"_(file)_"},{R"_(attributeNames)_",R"_(entity	constraint	message)_"},{R"_(auxArity)_",R"_(0)_"},{R"_(name)_",R"_(violation)_"},{R"_(operation)_",R"_(output)_"},{R"_(output-dir)_",R"_(results)_"},{R"_(params)_",R"_({"records": {}, "relation": {"arity": 3, "params": ["entity", "constraint", "message"]}})_"},{R"_(types)_",R"_({"ADTs": {}, "records": {}, "relation": {"arity": 3, "types": ["s:symbol", "s:symbol", "s:symbol"]}})_"}});
...
void Sf_souffleARpHRt::loadAll([[maybe_unused]] std::string inputDirectoryArg){
try {std::map<std::string, std::string> directiveMap({{R"_(IO)_",R"_(file)_"},{R"_(attributeNames)_",R"_(entity	value)_"},{R"_(auxArity)_",R"_(0)_"},{R"_(fact-dir)_",R"_(results/facts)_"},{R"_(name)_",R"_(birthDate)_"},{R"_(operation)_",R"_(input)_"},{R"_(params)_",R"_({"records": {}, "relation": {"arity": 2, "params": ["entity", "value"]}})_"},{R"_(types)_",R"_({"ADTs": {}, "records": {}, "relation": {"arity": 2, "types": ["s:symbol", "s:symbol"]}})_"}});
...
void Sf_souffleARpHRt::dumpInputs(){
...
void Sf_souffleARpHRt::dumpOutputs(){
try {std::map<std::string, std::string> rwOperation;
rwOperation["IO"] = "stdout";
...
SymbolTable& Sf_souffleARpHRt::getSymbolTable(){
return symTable;
}

RecordTable& Sf_souffleARpHRt::getRecordTable(){
return recordTable;
}

void Sf_souffleARpHRt::setNumThreads(std::size_t numThreadsValue){
...
void Sf_souffleARpHRt::executeSubroutine(std::string name,const std::vector<RamDomain>& args,std::vector<RamDomain>& ret){
...
namespace souffle {
SouffleProgram *newInstance_souffleARpHRt(){return new  souffle::Sf_souffleARpHRt;}
SymbolTable *getST_souffleARpHRt(SouffleProgram *p){return &reinterpret_cast<souffle::Sf_souffleARpHRt*>(p)->getSymbolTable();}
} // namespace souffle
...
namespace  souffle {
using namespace souffle;
class factory_Sf_souffleARpHRt: souffle::ProgramFactory {
public:
souffle::SouffleProgram* newInstance();
 factory_Sf_souffleARpHRt();
private:
};
} // namespace  souffle
namespace  souffle {
using namespace souffle;
souffle::SouffleProgram* factory_Sf_souffleARpHRt::newInstance(){
return new  souffle::Sf_souffleARpHRt();
}

 factory_Sf_souffleARpHRt::factory_Sf_souffleARpHRt():
souffle::ProgramFactory("souffleARpHRt"){
}
...
extern "C" {
souffle::factory_Sf_souffleARpHRt __factory_Sf_souffleARpHRt_instance;
}
#endif
} // namespace souffle
