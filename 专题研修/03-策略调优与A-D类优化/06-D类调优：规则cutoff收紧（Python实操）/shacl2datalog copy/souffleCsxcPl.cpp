...
namespace  souffle {
using namespace souffle;
class Sf_souffleCsxcPl: public SouffleProgram {
public:
 Sf_souffleCsxcPl();
 ~Sf_souffleCsxcPl();
void run();
...
namespace  souffle {
using namespace souffle;
 Sf_souffleCsxcPl::Sf_souffleCsxcPl():
symTable({
  R"_(minCount)_",
...
void Sf_souffleCsxcPl::runFunction(std::string inputDirectoryArg,std::string outputDirectoryArg,bool performIOArg,bool pruneImdtRelsArg){
...
void Sf_souffleCsxcPl::run(){
runFunction("", "", false, false);
}

void Sf_souffleCsxcPl::runAll(std::string inputDirectoryArg,std::string outputDirectoryArg,bool performIOArg,bool pruneImdtRelsArg){
runFunction(inputDirectoryArg, outputDirectoryArg, performIOArg, pruneImdtRelsArg);
}

void Sf_souffleCsxcPl::printAll([[maybe_unused]] std::string outputDirectoryArg){
try {std::map<std::string, std::string> directiveMap({{R"_(IO)_",R"_(file)_"},{R"_(attributeNames)_",R"_(entity	constraint	message)_"},{R"_(auxArity)_",R"_(0)_"},{R"_(name)_",R"_(violation)_"},{R"_(operation)_",R"_(output)_"},{R"_(output-dir)_",R"_(results)_"},{R"_(params)_",R"_({"records": {}, "relation": {"arity": 3, "params": ["entity", "constraint", "message"]}})_"},{R"_(types)_",R"_({"ADTs": {}, "records": {}, "relation": {"arity": 3, "types": ["s:symbol", "s:symbol", "s:symbol"]}})_"}});
...
void Sf_souffleCsxcPl::loadAll([[maybe_unused]] std::string inputDirectoryArg){
try {std::map<std::string, std::string> directiveMap({{R"_(IO)_",R"_(file)_"},{R"_(attributeNames)_",R"_(entity)_"},{R"_(auxArity)_",R"_(0)_"},{R"_(fact-dir)_",R"_(results/facts)_"},{R"_(name)_",R"_(person)_"},{R"_(operation)_",R"_(input)_"},{R"_(params)_",R"_({"records": {}, "relation": {"arity": 1, "params": ["entity"]}})_"},{R"_(types)_",R"_({"ADTs": {}, "records": {}, "relation": {"arity": 1, "types": ["s:symbol"]}})_"}});
...
void Sf_souffleCsxcPl::dumpInputs(){
...
void Sf_souffleCsxcPl::dumpOutputs(){
try {std::map<std::string, std::string> rwOperation;
rwOperation["IO"] = "stdout";
...
SymbolTable& Sf_souffleCsxcPl::getSymbolTable(){
return symTable;
}

RecordTable& Sf_souffleCsxcPl::getRecordTable(){
return recordTable;
}

void Sf_souffleCsxcPl::setNumThreads(std::size_t numThreadsValue){
...
void Sf_souffleCsxcPl::executeSubroutine(std::string name,const std::vector<RamDomain>& args,std::vector<RamDomain>& ret){
...
namespace souffle {
SouffleProgram *newInstance_souffleCsxcPl(){return new  souffle::Sf_souffleCsxcPl;}
SymbolTable *getST_souffleCsxcPl(SouffleProgram *p){return &reinterpret_cast<souffle::Sf_souffleCsxcPl*>(p)->getSymbolTable();}
} // namespace souffle
...
namespace  souffle {
using namespace souffle;
class factory_Sf_souffleCsxcPl: souffle::ProgramFactory {
public:
souffle::SouffleProgram* newInstance();
 factory_Sf_souffleCsxcPl();
private:
};
} // namespace  souffle
namespace  souffle {
using namespace souffle;
souffle::SouffleProgram* factory_Sf_souffleCsxcPl::newInstance(){
return new  souffle::Sf_souffleCsxcPl();
}

 factory_Sf_souffleCsxcPl::factory_Sf_souffleCsxcPl():
souffle::ProgramFactory("souffleCsxcPl"){
}
...
extern "C" {
souffle::factory_Sf_souffleCsxcPl __factory_Sf_souffleCsxcPl_instance;
}
#endif
} // namespace souffle
