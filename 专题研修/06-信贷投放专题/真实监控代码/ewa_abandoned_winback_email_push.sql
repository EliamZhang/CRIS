INSERT INTO ba.ewa_abandoned_winback_email_push
SELECT  
    to_json(
...
FROM
    ...
    FROM 
        ...
        AND datediff('${yyyy-mm-dd+1}', fst_has_limit_time) IN (3,7,14,53) -- 限定 T+n
        ...
        AND datediff('${yyyy-mm-dd+1}', a.previous_settle_time) IN (14,28,42) -- 限定 T+n
        )
    WHERE user_id NOT IN 
        (SELECT DISTINCT user_id
        FROM ods.dwd_mkt_iterable_email_bounce_dtl
        WHERE account_id=31467
        AND recipient_state='HardBounce'
